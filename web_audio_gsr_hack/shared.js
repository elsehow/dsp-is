...
var get_white_noise_source = function(channels, frameCount, frameRate) {
    var buffer = context.createBuffer(channels, frameCount, frameRate);
    for (var channel = 0; channel < channels; channel++) {
        var b = buffer.getChannelData(channel);
